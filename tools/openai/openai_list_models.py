...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--proxy-url",
        default=os.getenv("PROXY_URL", "http://localhost:8000"),
        help="Proxy base URL (without /v1). Default: %(default)s"
    )
    parser.add_argument(
        "--api-key",
        default=os.getenv("OPENAI_API_KEY", "sk-16AwYoZqNoVKjfMz-Mr8TeuaXk3O6JeLwPdQSAQiF0s"),
